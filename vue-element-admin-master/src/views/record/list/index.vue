...
export default {
  ...
  data() {
    return {
      ...
      playvideo: 'http://192.168.28.179:5000/video', // 存储用户点击的视频播放链接
      postsrc:'http://192.168.28.179:5000/',
      chartsrc:[{url:'http://192.168.28.179:5000/cameraindex_image',text:'摄像头统计'},{url:'http://192.168.28.179:5000/time_image',text:'时间统计'}],
      listQuery: {
        page: 1,
        limit: 20,
        id: undefined,
